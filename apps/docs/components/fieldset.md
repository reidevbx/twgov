...
<DemoBlock direction="column" variant="default">
  <govtw-fieldset>
    ...
    <govtw-text-input label="電子信箱" name="email" type="email" hint="例如：user@example.gov.tw"></govtw-text-input>
    <govtw-text-input label="電話" name="phone" type="tel" width="10"></govtw-text-input>
  </govtw-fieldset>
...
<DemoBlock direction="column" variant="hint">
  <govtw-fieldset>
    ...
    <govtw-text-input label="縣市" width="10"></govtw-text-input>
    <govtw-text-input label="區鄉鎮市" width="10"></govtw-text-input>
    <govtw-text-input label="街道地址"></govtw-text-input>
  </govtw-fieldset>
...
<DemoBlock direction="column" variant="error">
  <govtw-fieldset error="請填寫完整的出生日期">
    ...
    <div style="display: flex; gap: 12px;">
      <govtw-text-input label="年" width="4" error=" "></govtw-text-input>
      <govtw-text-input label="月" width="2" error=" "></govtw-text-input>
      <govtw-text-input label="日" width="2" error=" "></govtw-text-input>
    </div>
  </govtw-fieldset>
...
<govtw-fieldset>
  <h2 slot="legend">聯絡資訊</h2>
  <govtw-text-input label="姓名" name="name"></govtw-text-input>
  <govtw-text-input label="電子信箱" name="email" type="email"></govtw-text-input>
</govtw-fieldset>
```
...
<govtw-fieldset error="地址不完整，請檢查">
  <h2 slot="legend">寄送地址</h2>
  <p slot="hint">請填寫您希望收到文件的地址</p>
  <govtw-text-input label="縣市"></govtw-text-input>
  <govtw-text-input label="街道地址"></govtw-text-input>
</govtw-fieldset>
```
...
- 單一獨立欄位不需要 fieldset，使用 `<govtw-text-input>` 即可
- 欄位之間沒有明確的群組關係
